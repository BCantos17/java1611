 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://soap_server.revature.com/", wsdlLocation = "http://10.255.184.248:9001/soap-server/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://soap_server.revature.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.255.184.248:9001/soap-server/HelloWorld?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://soap_server.revature.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap_server.revature.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
