 ...
 * 2017-01-10T14:19:47.663-05:00
 * Generated source version: 3.1.3
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", 
                  wsdlLocation = "http://localhost:9001/soap-server/HelloWorld?wsdl",
...
public class HelloWorldImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:9001/soap-server/HelloWorld?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:9001/soap-server/HelloWorld?wsdl");
        }
        WSDL_LOCATION = url;
    }
